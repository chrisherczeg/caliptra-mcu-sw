...
const MLDSA_CERT_DER_SIZE: u32 = 7547;

/// Last 64 bytes of the ML-DSA-87 IDevID certificate (partition 0x02).
pub static MLDSA_CERT_TAIL: [u8; 64] = [
    0x64, 0x6e, 0x83, 0x89, 0xa8, 0xc0, 0xc4, 0x00, 0x20, 0x4e, 0x83, 0x9b, 0xef, 0x13, 0x1f, 0x38,
    0x54, 0x7a, 0x80, 0x8e, 0x95, 0xd3, 0xe7, 0x35, 0x3f, 0x8e, 0xb6, 0x00, 0x1b, 0x1e, 0x2c, 0x36,
    0x4b, 0x58, 0x61, 0xaa, 0xc5, 0xc7, 0xe4, 0x11, 0x2b, 0x3c, 0x4a, 0x5a, 0x86, 0x96, 0x98, 0xa4,
    0xbd, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x0e, 0x1a, 0x20, 0x2a, 0x2e, 0x3a, 0x45,
];
...
pub(crate) async fn test_external_otp() {
    ...
    // Partition 0x02 reserves 7741 bytes; the provisioned DER is shorter.
    ...
    {
        let tail_start = MLDSA_CERT_DER_SIZE - 64;
        let mut offset = 0u32;
        while offset + 4 <= 64 {
            let mut word_bytes = [0u8; 4];
